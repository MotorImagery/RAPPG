...
class ExperimentProcessor:
    def __init__(self, subject_number):
        ...
        self.channel_num = 3
        self.lr = 0.002
        self.epoch_number = 100#1500
        self.batch_size = 200 # 600
    ...
    def train(self):
        ...
        for epoch in range(self.epoch_number):
            ...
            for i, (t_data, t_label) in enumerate(train_loader):
                t_data, t_label = t_data.cuda(), t_label.cuda()
            ...
            if test_acc > best_accuracy:
                ...
                torch.save(self.net.state_dict(), './ckpts/hgd/{}_best.pth'.format(self.subject_number))
